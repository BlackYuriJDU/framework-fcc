...
- Geração/modificação de preço sem confirmação de o proprietário → REJECT
...
- Mudança de preço → APPROVE apenas com confirmação explícita de o proprietário
...
- [ ] Alguém (o proprietário) precisa aprovar antes?
